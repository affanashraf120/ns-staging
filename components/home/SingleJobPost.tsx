...
const SingleJobPost = (props: SingleJobProps) => (
    <div
        ...
        <div className="relative lg:max-w-5xl lg:mx-auto">
            {props.job.hotJob === 'yes' && <div className="absolute -inset-2">
            ...
            <div
                className="grid grid-cols-2 sm:grid-cols-4  justify-items-start  p-6 bg-white relative rounded-xl border border-gray-100">
                ...
                <div
                    className="text-sm flex flex-col justify-around justify-self-center">
                    <div>
                        <span className="font-medium mb-1">Date Posted:</span>
                        <br />
                        <span className="text-gray-500">{props.job.datePosted}</span>
                    </div>
                    <div>
                        <span className="font-medium">Job Type:</span>
                        <br />
                        <span className="text-gray-500">{props.job.jobType}</span>
                    </div>
                </div>
