...
const companies = [
    ...
    {
        newTab: true,
        url: "https://2657756a-9086-4736-b339-56a4fbf952af.site.hbuptime.com/",
        title: "Uptime Status"
    },
]
    ...
    return (
        <footer className="py-12 bg-white sm:pt-16 lg:pt-20">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                {/* <a href="#" title="" className="text-base font-medium text-gray-900 transition-all duration-200 rounded focus:outline-none font-pj hover:text-opacity-50 focus:ring-1 focus:ring-gray-900 focus:ring-offset-2"> nurse seeking</a> */}
                ...
                <div className="grid grid-cols-2 mt-16 sm:grid-cols-3 gap-y-16 lg:grid-cols-6 gap-x-16">
                    <div>
                        ...
                        <ul className="mt-8 space-y-5">
                            {companies.map(({ url, title, newTab }, i) => <li key={i} >
                                <Link href={url}>
                                    <a
                                        {...newTab && {
                                            target: "_blank"
                    ...
                    <div className="col-span-2 sm:col-span-1">
                        ...
                        <ul className="mt-8 space-y-5">
                            {resources.map(({ url, title }, i) => <li key={i} >
                                <Link href={url}>
                                    <a
                                        title=""
                                        className="inline-flex text-sm font-normal text-gray-900 transition-all duration-300 transform font-pj hover:text-gray-600 hover:translate-x-1"
                        ...
                        <div className="grid grid-cols-1 mt-8 gap-y-8 sm:grid-cols-2 sm:gap-x-16">
                            <div>
                                ...
                                <p className="mt-2.5 text-xl font-pj text-gray-900 font-bold">
                                    <a href="mailto:info@nurseseeking.com" title="">
                                        {" "}
                                        info@nurseseeking.com{" "}
                                    </a>
                                </p>
                            </div>
                        </div>
                ...
                <div className="mt-8 sm:flex sm:items-center sm:justify-between">
                    <ul className="flex items-center justify-start space-x-3 sm:order-2 sm:justify-end">
                        <li>
                            <a
                                href="https://twitter.com/nurse_seeking"
                                target="_blank"
                                title=""
                        ...
                        <li>
                            <a
                                href="https://www.facebook.com/nurseseeking"
                                target="_blank"
                                title=""
                                className="inline-flex items-center justify-center w-10 h-10 text-gray-900 transition-all duration-200 rounded-full hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-offset-2 focus:ring-gray-200"
                                rel="noopener noreferrer"
                        ...
                        <li>
                            <a
                                href="https://www.instagram.com/nurseseeking/"
                                target="_blank"
                                title=""
                                className="inline-flex items-center justify-center w-10 h-10 text-gray-900 transition-all duration-200 rounded-full hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-offset-2 focus:ring-gray-200"
                                rel="noopener noreferrer"
