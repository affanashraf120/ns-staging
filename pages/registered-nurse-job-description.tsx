        ...
        <section className="py-12 bg-white sm:py-16 lg:py-20">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto xl:max-w-4xl">
                    <p className="text-sm font-bold tracking-widest text-gray-400 uppercase font-pj">POSITION DESCRIPTION</p>
                    <h1 className="text-3xl font-bold text-gray-900 mt-7 sm:text-4xl xl:text-5xl font-pj">Registered Nurse.</h1>
                    <p className="text-sm font-normal text-gray-600 mt-7 font-pj">April 14, 2021</p>
                    ...
                    <div className="mt-10">
                        ...
                        <h2 className="mt-12 text-3xl font-bold text-gray-900 font-pj"> PURPOSE</h2>
                        ...
                        <h2 className="mt-12 text-3xl font-bold text-gray-900 font-pj">REQUIREMENTS</h2>
                        <p className="mt-6 text-base font-normal leading-7 text-gray-700 font-pj">
                            Massa risus sed eget ornare posuere turpis vitae. Id elementum velit posuere vestibulum lectus id eu sollicitudin. Tellus amet bibendum sit mus phasellus quis duis lacus. Enim eget sagittis, auctor iaculis nulla semper. In vitae neque integer integer metus, est, tristique
                            fermentum tristique.
                        </p>
                        ...
                        <h2 className="mt-16 text-3xl font-bold text-gray-900 font-pj">SELECTION CRITERIA</h2>
                        <p className="mt-6 text-base font-normal leading-7 text-gray-700 font-pj">
